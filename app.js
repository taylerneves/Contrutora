...
const propertiesData = [
  {
    ...
    category: "area-rural",
    purpose: "venda",
    location: "ZONA RURAL, ROLIM DE MOURA - RO",
    price: 1200000,
    oldPrice: null,
    image: "assets/rural_area.png",
    description: "Excelente propriedade rural de 21 hectares localizada na Zona Rural de Rolim de Moura. Solo altamente fértil, perfeito para cultivo agrícola ou atividade pecuária. Conta com boa topografia, piquetes divididos e fartura de água com córrego natural corrente. Uma das melhores opções de terra na região de Rolim de Moura.",
    specs: {
      quartos: 0,
      suites: 0,
      banheiros: 0,
  ...
  {
    ref: "39",
    title: "Terreno à venda, PLANALTO, ROLIM DE MOURA - RO",
    category: "terreno",
    purpose: "venda",
    location: "PLANALTO, ROLIM DE MOURA - RO",
    price: 60000,
    oldPrice: null,
    image: "assets/modern_house.png",
    description: "Excelente terreno residencial à venda no Bairro Planalto em Rolim de Moura - RO. Terreno plano, seco, pronto para receber construção imediata. Bairro tranquilo, com rede de energia elétrica, iluminação pública e água encanada já disponíveis na rua. Perfeito para quem busca sair do aluguel ou investir na casa própria.",
    specs: {
      quartos: 0,
      suites: 0,
      banheiros: 0,
  ...
  {
    ref: "11",
    title: "Vende Terreno 420m², Bairro Jequitibá- ROLIM DE MOURA - RO",
    category: "terreno",
    purpose: "venda",
    location: "Jequitibá, ROLIM DE MOURA - RO",
    price: 110000,
    oldPrice: 120000,
    image: "assets/modern_house.png",
    description: "Ótima oportunidade de investimento! Amplo terreno com 420 metros quadrados, situado no conceituado Bairro Jequitibá em Rolim de Moura. Lote com demarcações corretas, em rua projetada para asfalto próximo. Localização em franco desenvolvimento com forte índice de valorização imobiliária residencial.",
    specs: {
      quartos: 0,
      suites: 0,
      banheiros: 0,
  ...
  {
    ref: "62",
    title: "Casa à venda, 04 QUARTOS, PLANALTO, ROLIM DE MOURA - RO",
    category: "casa",
    purpose: "venda",
    location: "PLANALTO, ROLIM DE MOURA - RO",
    price: 450000,
    oldPrice: null,
    image: "assets/modern_house.png",
    description: "Belíssima e espaçosa residência contendo 4 quartos, ideal para famílias grandes. Localizada no Bairro Planalto, a casa dispõe de salas integradas, copa, cozinha bem iluminada, despensa, área de serviços e uma excelente varanda na frente. Garagem coberta e quintal totalmente murado proporcionando total segurança.",
    specs: {
      quartos: 4,
      suites: 0,
      banheiros: 2,
  ...
  },
  {
    ...
    oldPrice: null,
    image: "assets/modern_house.png",
    description: "Terreno urbano comercial/residencial de 300m² no Bairro Industrial de Rolim de Moura. Lote plano e limpo, muito bem localizado na região industrial, ideal para pequenas oficinas, depósitos ou moradias operárias. Excelente custo-benefício.",
    specs: {
      quartos: 0,
      suites: 0,
      banheiros: 0,
  ...
  {
    ref: "60",
    title: "IMOVEL Comercial à venda, Centro, ROLIM DE MOURA - RO",
    category: "comercio",
    purpose: "venda",
    location: "Centro, ROLIM DE MOURA - RO",
    price: 1300000,
    oldPrice: 1900000,
    image: "assets/luxury_condo.png",
    description: "Excelente prédio comercial com preço promocional reduzido. Localizado no coração do Centro de Rolim de Moura, este imóvel tem grande fluxo de pedestres e carros. Possui amplo salão comercial térreo com portas de enrolar, divisórias, mezanino para escritório, banheiros masculino/feminino adaptados e refeitório.",
    specs: {
      quartos: 0,
      suites: 0,
      banheiros: 3,
  ...
  {
    ref: "19",
    title: "Edifício Prédio à venda, Centro, ROLIM DE MOURA - RO",
    ...
    oldPrice: 700000,
    image: "assets/luxury_condo.png",
    description: "Edifício residencial com fins comerciais no Centro de Rolim de Moura. Possui 2 salas comerciais amplas no piso inferior e 4 apartamentos de 2 quartos no piso superior. Excelente oportunidade para investidores que desejam renda imediata através da locação mensal das unidades.",
    specs: {
      quartos: 8,
      suites: 0,
      banheiros: 6,
  ...
  {
    ref: "3",
    title: "Casa à venda, Centro, ROLIM DE MOURA - RO, 196,95m² construído",
    category: "casa",
    purpose: "venda",
    location: "Centro, ROLIM DE MOURA - RO",
    price: 750000,
  ...
  {
    ref: "23",
    title: "Casa à venda Alto Padrão, CONDOMÍNIO KLUSKA, ROLIM DE MOURA - RO",
    category: "casa",
    purpose: "venda",
    location: "CONDOMÍNIO KLUSKA, Centro, ROLIM DE MOURA - RO",
    price: 1250000,
    oldPrice: 1400000,
    image: "assets/luxury_condo.png",
    description: "Extraordinária casa térrea de alto padrão localizada no Condomínio Fechado Kluska, o mais seguro e cobiçado de Rolim de Moura. Acabamento primoroso com piso em porcelanato polido de grandes formatos, rebaixamento em gesso com projeto luminotécnico instalado. Possui 3 amplos quartos sendo 2 suítes elegantes, sala de estar com pé direito duplo, cozinha gourmet com churrasqueira integrada, quintal gramado e garagem coberta para até 4 veículos.",
    specs: {
      quartos: 3,
      suites: 2,
      banheiros: 3,
...
function renderProperties() {
  ...
  if (filtered.length === 0) {
    ...
    filtered.forEach((item, index) => {
      ...
      const oldPriceFormatted = item.oldPrice ? item.oldPrice.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' }) : null;
...
window.openPropertyDetails = function(ref) {
  ...
  const message = `Olá Sallami Imobiliária! Fiquei interessado no imóvel Ref. ${item.ref} (${item.title}). Gostaria de agendar uma visita ou receber mais informações.`;
...
function initFinderForm() {
  ...
  form.addEventListener("submit", (e) => {
    ...
    const message = `Olá Sallami Imobiliária! Gostaria que encontrassem um imóvel sob medida para mim. Seguem minhas preferências:
- Nome: ${name}
- Ação: Quero ${purpose}
- Tipo: ${type}
